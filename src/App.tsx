...
const projects: Project[] = [
  { id: '01', title: "L'EAU PAPIER", cnTitle: '纸上之水', category: 'NARRATIVE FILM', year: '2026', duration: '06:01', image: '/posters/narrative/new-film.jpg', video: '/media/narrative/new-film.mp4', layout: 'wide' },
  { id: '02', title: "L'OMBRE DANS L'EAU", cnTitle: '水中暗影', category: 'SHORT VIDEO', year: '2026', duration: '02:06', image: '/posters/short-video/misunderstanding.jpg', video: '/media/short-video/misunderstanding.mp4', layout: 'standard' },
  { id: '03', title: 'ORPHÉON', cnTitle: '奥菲昂之夜', category: 'SHORT DRAMA', year: '2026', duration: '01:55', image: '/posters/short-drama/short-drama.jpg', video: '/media/short-drama/short-drama.mp4', layout: 'standard' },
  { id: '04', title: 'FLEUR DE PEAU', cnTitle: '肌肤之花', category: 'MUSIC VIDEO', year: '2026', duration: '01:52', image: '/posters/music-video/emotion.jpg', video: '/media/music-video/emotion.mp4', layout: 'standard' },
  { id: '05', title: 'BOIS CORSÉ', cnTitle: '深邃之木', category: 'SHORT VIDEO', year: '2026', duration: '01:46', image: '/posters/short-video/assessment.jpg', video: '/media/short-video/assessment.mp4', layout: 'standard' },
  { id: '06', title: 'EAU DES SENS', cnTitle: '感官之水', category: 'SHORT VIDEO', year: '2026', duration: '01:42', image: '/posters/short-video/ice-cream.jpg', video: '/media/short-video/ice-cream.mp4', layout: 'standard' },
  { id: '07', title: 'EAU DUELLE', cnTitle: '双生之水', category: 'SHORT VIDEO', year: '2026', duration: '01:39', image: '/posters/short-video/argument.jpg?v=2', video: '/media/short-video/argument-v2.mp4', layout: 'standard' },
  { id: '08', title: 'ANOTHER 13', cnTitle: '另一章', category: 'SHORT VIDEO', year: '2026', duration: '01:27', image: '/posters/short-video/episode-02.jpg', video: '/media/short-video/episode-02.mp4', layout: 'standard' },
  { id: '09', title: "ROSE OF NO MAN'S LAND", cnTitle: '无人区玫瑰', category: 'MUSIC VIDEO', year: '2026', duration: '01:26', image: '/posters/music-video/war.jpg', video: '/media/music-video/war.mp4', layout: 'standard' },
  { id: '10', title: 'BLANCHE', cnTitle: '纯白', category: 'SHORT VIDEO', year: '2026', duration: '01:25', image: '/posters/short-video/in-mothers-eyes.jpg', video: '/media/short-video/in-mothers-eyes.mp4', layout: 'standard' },
  { id: '11', title: 'POPPY & BARLEY', cnTitle: '罂粟与麦田', category: 'SHORT VIDEO', year: '2026', duration: '01:19', image: '/posters/short-video/rice-field.jpg', video: '/media/short-video/rice-field.mp4', layout: 'standard' },
  { id: '12', title: 'BLACK SAFFRON', cnTitle: '黑色藏红花', category: 'SHORT VIDEO', year: '2026', duration: '01:10', image: '/posters/short-video/car-check.jpg', video: '/media/short-video/car-check.mp4', layout: 'standard' },
  { id: '13', title: 'ILIO', cnTitle: '伊利欧', category: 'SHORT VIDEO', year: '2026', duration: '01:07', image: '/posters/short-video/episode-01.jpg', video: '/media/short-video/episode-01.mp4', layout: 'standard' },
  { id: '14', title: 'THÉ MATCHA 26', cnTitle: '抹茶冥想', category: 'SHORT VIDEO', year: '2026', duration: '01:05', image: '/posters/short-video/study-hard.jpg', video: '/media/short-video/study-hard.mp4', layout: 'standard' },
  { id: '15', title: 'ENGLISH PEAR & FREESIA', cnTitle: '英国梨与小苍兰', category: 'SHORT VIDEO', year: '2026', duration: '01:03', image: '/posters/short-video/english.jpg', video: '/media/short-video/english.mp4', layout: 'standard' },
  { id: '16', title: 'WILD BLUEBELL', cnTitle: '野风铃', category: 'SHORT VIDEO', year: '2026', duration: '01:01', image: '/posters/short-video/cold.jpg', video: '/media/short-video/cold.mp4', layout: 'standard' },
  { id: '17', title: 'TAM DAO', cnTitle: '檀道', category: 'MUSIC VIDEO', year: '2026', duration: '00:56', image: '/posters/music-video/swordsman.jpg', video: '/media/music-video/swordsman.mp4', layout: 'standard' },
  { id: '18', title: 'SUNDAZED', cnTitle: '日光迷醉', category: 'PORTRAIT MV', year: '2026', duration: '00:44', image: '/posters/portrait-mv/summer.jpg', video: '/media/portrait-mv/summer.mp4', layout: 'standard' },
  { id: '19', title: 'PORTRAIT OF A LADY', cnTitle: '贵妇肖像', category: 'PORTRAIT MV', year: '2026', duration: '00:30', image: '/posters/portrait-mv/portrait-01.jpg', video: '/media/portrait-mv/portrait-01.mp4', layout: 'standard' },
  { id: '20', title: 'WOOD SAGE & SEA SALT', cnTitle: '鼠尾草与海盐', category: 'PORTRAIT MV', year: '2026', duration: '00:29', image: '/posters/portrait-mv/seaside.jpg', video: '/media/portrait-mv/seaside.mp4', layout: 'standard' },
  { id: '21', title: 'COFFEE BREAK', cnTitle: '咖啡小憩', category: 'VLOG', year: '2026', duration: '00:34', image: '/posters/vlog/coffee-sunset.jpg', video: '/media/vlog/coffee-sunset.mp4', layout: 'standard' },
  { id: '22', title: 'BIBLIOTHÈQUE', cnTitle: '图书馆', category: 'VLOG', year: '2026', duration: '00:36', image: '/posters/vlog/toy-store-day.jpg', video: '/media/vlog/toy-store-day.mp4', layout: 'standard' },
  { id: '23', title: "TERRE D'HERMÈS", cnTitle: '大地', category: 'VLOG', year: '2026', duration: '00:30', image: '/posters/vlog/south-wind-pottery.jpg', video: '/media/vlog/south-wind-pottery.mp4', layout: 'standard' },
]
